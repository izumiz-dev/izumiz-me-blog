...
export const GALLERY_ID =
  import.meta.env.GALLERY_ID || process.env.GALLERY_ID || '';

export const BOOK_REVIEW_ID =
  import.meta.env.BOOK_REVIEW_ID || process.env.BOOK_REVIEW_ID || '';
...
export const NUMBER_OF_GALLERY_PER_PAGE = 4;
export const NUMBER_OF_BOOK_REVIEWS_PER_PAGE = 10;
export const NUMBER_OF_TIMELINE_PER_PAGE = 10;
